defmodule JidoCoderLib.Session.SupervisorTest do
  use ExUnit.Case, async: false

  alias JidoCoderLib.Session.Supervisor
    ...
    test "starts context manager child" do
      ...
      assert Enum.any?(children, fn
               {id, child_pid, _, _} when is_pid(child_pid) ->
                 id == JidoCoderLib.Agents.ContextManager and Process.alive?(child_pid)
