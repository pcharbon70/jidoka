defmodule JidoCoderLib.Memory.IntegrationTest do
  use ExUnit.Case, async: false

  alias JidoCoderLib.Memory.{Integration, ShortTerm}
  alias JidoCoderLib.Memory.LongTerm.SessionAdapter
  alias JidoCoderLib.Agents.ContextManager
  alias JidoCoderLib.Signals.Memory
  ...
  describe "retrieve_memories/3" do
    setup do
      ...
      JidoCoderLib.PubSub.subscribe("signals")
