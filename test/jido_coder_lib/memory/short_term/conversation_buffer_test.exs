defmodule JidoCoderLib.Memory.ShortTerm.ConversationBufferTest do
  use ExUnit.Case, async: true

  alias JidoCoderLib.Memory.ShortTerm.ConversationBuffer
  ...
  describe "add/2" do
    ...
    test "returns evicted messages when budget exceeded" do
      ...
      budget = %JidoCoderLib.Memory.TokenBudget{
        max_tokens: 100,
