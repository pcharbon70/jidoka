defmodule JidoCoderLib.Codebase.QueriesTest do
  use ExUnit.Case, async: false

  alias JidoCoderLib.Codebase.Queries
  ...
  defp clear_elixir_codebase_graph do
    ...
    ctx =
      JidoCoderLib.Knowledge.Engine.context(:knowledge_engine)
      |> Map.put(:transaction, nil)
      |> JidoCoderLib.Knowledge.Context.with_permit_all()

    {:ok, graph_iri} = JidoCoderLib.Knowledge.NamedGraphs.iri_string(:elixir_codebase)
