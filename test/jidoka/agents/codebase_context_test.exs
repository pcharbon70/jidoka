defmodule Jidoka.Agents.CodebaseContextTest do
  ...
  describe "get_module_info/2" do
    test "returns module info when module exists" do
      ...
      case CodebaseContext.get_module_info("Jidoka.Indexing.CodeIndexer") do
        {:ok, info} ->
          assert is_map(info)
          assert info.name == "Jidoka.Indexing.CodeIndexer"
    ...
    test "caches module info results" do
      ...
      case CodebaseContext.get_module_info("Jidoka.Agents.CodebaseContext") do
        {:ok, info1} ->
          # Second call - cache hit
          assert {:ok, ^info1} =
                   CodebaseContext.get_module_info("Jidoka.Agents.CodebaseContext")
    ...
    test "respects use_cache option" do
      ...
      # Without cache
      result1 =
        CodebaseContext.get_module_info("Jidoka.Agents.ContextManager",
          use_cache: false
        )
  ...
  describe "get_dependencies/2" do
    test "returns dependencies for a module" do
      ...
      case CodebaseContext.get_dependencies("Jidoka.Agents.ContextManager") do
    ...
    test "respects depth parameter" do
      ...
      case CodebaseContext.get_dependencies("Jidoka.Agents.ContextManager", depth: 0) do
        {:ok, deps} ->
    ...
    test "caches dependency results" do
      ...
      case CodebaseContext.get_dependencies("Jidoka.Agents.ContextManager", depth: 1) do
        {:ok, deps1} ->
          # Second call should hit cache
          assert {:ok, ^deps1} =
                   CodebaseContext.get_dependencies("Jidoka.Agents.ContextManager",
                     depth: 1
                   )
  ...
  describe "find_related/2" do
    test "finds related modules" do
      ...
      case CodebaseContext.find_related(["Jidoka.Agents.ContextManager"],
  ...
  describe "enrich/2" do
    ...
    test "returns context with modules for valid files" do
      ...
      files = ["lib/jidoka/agents/context_manager.ex"]
