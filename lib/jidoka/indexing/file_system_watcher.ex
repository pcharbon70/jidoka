defmodule Jidoka.Indexing.FileSystemWatcher do
  @moduledoc """
  ...
  * `:indexer_name` - The name of the CodeIndexer GenServer (default: `Jidoka.Indexing.CodeIndexer`)
  ...
  * `:name` - The name of the watcher GenServer (default: `__MODULE__`)
  ...
  @impl true
  def init(opts) do
    indexer_name = Keyword.get(opts, :indexer_name, Jidoka.Indexing.CodeIndexer)
  ...
  defp process_files(files, state) do
    ...
    :telemetry.execute(
      [:jidoka, :file_system_watcher, :batch_complete],
