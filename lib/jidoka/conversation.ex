defmodule Jidoka.Conversation do
  @moduledoc """
  ...
  | Module | Purpose |
  |--------|---------|
  | `Jidoka.Conversation.Logger` | Logging conversations to the knowledge graph |
  | `Jidoka.Conversation.Retrieval` | Querying and retrieving conversation history |
  | `Jidoka.Conversation.Analysis` | Analyzing conversation patterns |
