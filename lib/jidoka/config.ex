defmodule Jidoka.Config do
  @moduledoc """
  Configuration validation and helper module for Jidoka.
  ...
  ### LLM Configuration
      ...
      Jidoka.Config.llm_provider()
      # => :openai | :anthropic | :ollama | :mock | :none

      Jidoka.Config.llm_model()
      # => "gpt-4"

      Jidoka.Config.llm_api_key()
      # => "sk-..." or :error

  ### Knowledge Graph Configuration

      Jidoka.Config.knowledge_backend()
      # => :native | :remote_sparql

      Jidoka.Config.sparql_endpoint()
      # => "http://localhost:8080/sparql"

  ### Session Configuration

      Jidoka.Config.max_sessions()
      # => 100

      Jidoka.Config.session_idle_timeout()
      # => 300_000 (5 minutes)
  ...
  Validate all configuration at startup:
      ...
      case Jidoka.Config.validate_all() do
  ...
  Get a specific configuration value:
      ...
      provider = Jidoka.Config.llm_provider()
  ...
  ## Examples
      ...
      iex> Jidoka.Config.validate_all()
      :ok
  ...
  ## Examples
      ...
      iex> Jidoka.Config.llm_provider()
      :openai
  ...
  def llm_api_key do
    ...
    case provider do
      ...
      _ -> Jidoka.SecureCredentials.get_api_key(provider)
    end
  end
  ...
  ## Examples
      ...
      iex> Jidoka.Config.llm_max_tokens()
      4096
  ...
  ## Examples
      ...
      iex> Jidoka.Config.llm_temperature()
      0.7
  ...
  ## Examples
      ...
      iex> Jidoka.Config.llm_request_timeout()
      60_000
  ...
  ## Examples
      ...
      iex> Jidoka.Config.knowledge_backend()
      :native

  """
  def knowledge_backend do
    Application.get_env(:jidoka, :knowledge_graph, [])
  ...
  ## Examples
      ...
      iex> Jidoka.Config.sparql_endpoint()
      "http://localhost:8080/sparql"
  ...
  ## Examples
      ...
      iex> Jidoka.Config.knowledge_cache_enabled?()
      true
  ...
  ## Examples
      ...
      iex> Jidoka.Config.knowledge_max_cache_size()
      10_000
  ...
  ## Examples
      ...
      iex> Jidoka.Config.knowledge_cache_ttl()
      300_000
  ...
  ## Examples
      ...
      iex> Jidoka.Config.max_sessions()
      100

  """
  def max_sessions do
    Application.get_env(:jidoka, :session, [])
  ...
  ## Examples
      ...
      iex> Jidoka.Config.session_idle_timeout()
      300_000
  ...
  ## Examples
      ...
      iex> Jidoka.Config.session_absolute_timeout()
      3_600_000
  ...
  ## Examples
      ...
      iex> Jidoka.Config.session_cleanup_interval()
      60_000
  ...
  ## Examples
      ...
      iex> Jidoka.Config.operation_timeout()
      30_000

  """
  def operation_timeout do
    Application.get_env(:jidoka, :operation_timeout, 30_000)
  end
  ...
  ## Examples
      ...
      iex> Jidoka.Config.telemetry_enabled?()
      true
