defmodule JidoCoderLib.SecureCredentials do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, key} = JidoCoderLib.SecureCredentials.get_api_key(:openai)

      # Put an API key (for testing or runtime updates)
      :ok = JidoCoderLib.SecureCredentials.put_api_key(:openai, "sk-...")
  ...
  * `:error` - If the key is not found
  ...
  ## Examples
      ...
      iex> JidoCoderLib.SecureCredentials.put_api_key(:openai, "sk-test-key")
      iex> JidoCoderLib.SecureCredentials.get_api_key(:openai)
      {:ok, "sk-test-key"}

      iex> JidoCoderLib.SecureCredentials.get_api_key(:unknown)
      :error
  ...
  * `{:error, :invalid_key}` - If the key format is invalid
  ...
  ## Examples
      ...
      iex> JidoCoderLib.SecureCredentials.put_api_key(:openai, "sk-...")
      :ok
  ...
  * `:ok` - If the key was deleted (or didn't exist)
  ...
  ## Examples
      ...
      iex> JidoCoderLib.SecureCredentials.delete_api_key(:openai)
      :ok
  ...
  * `:ok` - Always succeeds
  ...
  defp load_keys_from_env do
    ...
    env_keys = Application.get_env(:jido_coder_lib, :api_keys, [])
