defmodule JidoCoderLib.TelemetryHandlers do
  @moduledoc """
  Telemetry event handlers for JidoCoderLib.
  ...
  def attach_log_handler do
    handler_id = "jido_coder_lib-telemetry-log-handler"

    :telemetry.attach(
      handler_id,
      # Attach to all jido_coder_lib events
      [:jido_coder_lib, :_, :_],
      &handle_log_event/4,
      nil
    )
  ...
  def detach_log_handler do
    :telemetry.detach("jido_coder_lib-telemetry-log-handler")
  end
  ...
  def attach_metrics_handler do
    handler_id = "jido_coder_lib-telemetry-metrics-handler"
  ...
  def detach_metrics_handler do
    :telemetry.detach("jido_coder_lib-telemetry-metrics-handler")
  end
  ...
  defp handle_log_event(event, measurements, metadata, _config) do
    ...
    if Application.get_env(:jido_coder_lib, :enable_telemetry, false) do
  ...
  defp log_event([:jido_coder_lib, component, action], measurements, metadata) do
  ...
  ## Example
      ...
      iex> JidoCoderLib.TelemetryHandlers.get_counters()
  ...
  ## Example
      ...
      iex> JidoCoderLib.TelemetryHandlers.get_duration_stats()
