defmodule JidoCoderLib.Agent do
  @moduledoc """
  Base utilities module for JidoCoderLib agents.
  ...
  and lifecycle management, this module focuses on jido_coder_lib-specific
  utilities for:
  ...
  Generate unique task IDs for tracking operations across the system:
      ...
      iex> task_id = JidoCoderLib.Agent.generate_task_id("analysis")
  ...
  Validate session IDs and session-related data:
      ...
      iex> JidoCoderLib.Agent.valid_session_id?("session-abc-123")
      true

      iex> JidoCoderLib.Agent.valid_session_id?("invalid!")
      false
  ...
  Create standardized error responses for agent actions:
      ...
      iex> JidoCoderLib.Agent.error_response(:validation_failed, %{field: :session_id})
  ...
  Find and query agents across both Jido's registry and the custom AgentRegistry:
      ...
      iex> {:ok, pid} = JidoCoderLib.Agent.find_agent("coordinator")
      iex> is_pid(pid)
      true

      iex> agents = JidoCoderLib.Agent.list_agents()
      iex> is_list(agents)
      true
  ...
  * `:session_id` - Optional session ID to include in the task ID
  ...
  ## Examples
      ...
      iex> task_id = JidoCoderLib.Agent.generate_task_id("chat", session_id: "session-123")
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.valid_session_id?(nil)
      false

      iex> JidoCoderLib.Agent.valid_session_id?("")
      false
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.validate_session_data(%{session_id: "session-123"})
      {:ok, %{session_id: "session-123"}}

      iex> JidoCoderLib.Agent.validate_session_data(%{session_id: nil})
      {:error, :invalid_session_id}

      iex> JidoCoderLib.Agent.validate_session_data(%{})
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.ok_response(%{status: :processed})
      {:ok, %{status: :processed}}
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.client_events_topic()
      "jido.client.events"
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.session_topic("session-123")
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.pubsub_name()
      :jido_coder_pubsub
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.jido_instance()
      JidoCoderLib.Jido

  """
  @spec jido_instance() :: atom()
  def jido_instance, do: JidoCoderLib.Jido
  ...
  * `:error` - If the agent is not found
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.find_agent("coordinator")
      {:ok, #PID<0.123.0>}

      # Find by full agent registry key
      iex> JidoCoderLib.Agent.find_agent("agent:coordinator")
      {:ok, #PID<0.123.0>}

      # Not found
      iex> JidoCoderLib.Agent.find_agent("nonexistent")
      :error
  ...
  * `:error` - If the agent is not found (returns nil)
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.find_agent_by_id("coordinator-main")
      {:ok, #PID<0.123.0>}

      iex> JidoCoderLib.Agent.find_agent_by_id("nonexistent")
      :error
  ...
  * `:error` - If the agent is not found
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.find_agent_by_name("coordinator")
      {:ok, #PID<0.123.0>}

      iex> JidoCoderLib.Agent.find_agent_by_name("agent:coordinator")
      {:ok, #PID<0.123.0>}

      iex> JidoCoderLib.Agent.find_agent_by_name("nonexistent")
      :error
  ...
  * List of `{agent_id, pid}` tuples where agent_id is the identifier
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.list_agents()
  ...
  * List of `{agent_id, pid}` tuples
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.list_jido_agents()
  ...
  * List of `{agent_name, pid}` tuples
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.list_registered_agents()
  ...
  * `false` - If the agent is not found or not alive
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.agent_active?("coordinator")
      true

      iex> JidoCoderLib.Agent.agent_active?("nonexistent")
      false
  ...
  * `false` - If the agent is not found or not alive
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.agent_responsive?("coordinator")
      true

      iex> JidoCoderLib.Agent.agent_responsive?("nonexistent")
      false
  ...
  * `:error` - If the coordinator is not found
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.coordinator()
      {:ok, #PID<0.123.0>}
  ...
  * `false` - If the coordinator is not found or not alive
  ...
  ## Examples
      ...
      iex> JidoCoderLib.Agent.coordinator_active?()
      true
