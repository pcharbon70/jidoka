defmodule JidoCoderLib.AgentRegistry do
  @moduledoc """
  ...
  * `"session:<uuid>"` - A user session
  ...
  Register the current process:
      ...
      iex> JidoCoderLib.AgentRegistry.register("agent:coordinator")
      {:ok, "agent:coordinator"}

  Look up a process by key:

      iex> JidoCoderLib.AgentRegistry.lookup("agent:coordinator")
      {:ok, pid}

  Dispatch a message to the registered process:

      iex> JidoCoderLib.AgentRegistry.dispatch("agent:coordinator", {:process, data})
      :ok

  Unregister the current process:

      iex> JidoCoderLib.AgentRegistry.unregister("agent:coordinator")
      :ok
  ...
  ## Examples
      ...
      iex> JidoCoderLib.AgentRegistry.valid_key?("agent:coordinator")
      true

      iex> JidoCoderLib.AgentRegistry.valid_key?("invalid")
      false
  ...
  * `:key` - The registration key (defaults to the provided key argument)
  ...
  ## Examples
      ...
      iex> JidoCoderLib.AgentRegistry.register("invalid-key")
      {:error, :invalid_key}
  ...
  * `:from` - The sender PID (defaults to self())
  ...
  ## Examples
      ...
      iex> JidoCoderLib.AgentRegistry.count("agent:coordinator")
      1
  ...
  ## Examples
      ...
      iex> JidoCoderLib.AgentRegistry.list_keys()
  ...
  ## Examples
      ...
      iex> JidoCoderLib.AgentRegistry.registered?("agent:coordinator")
      true
