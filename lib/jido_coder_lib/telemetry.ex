defmodule JidoCoderLib.Telemetry do
  @moduledoc """
  Standard telemetry event definitions for JidoCoderLib.

  This module defines all telemetry events emitted by the application.
  Events follow the pattern `[:jido_coder_lib, :component, :action]`.
  ...
  **Metadata:**
  ...
  def session_started, do: [:jido_coder_lib, :session, :started]
  ...
  **Metadata:**
  ...
  def session_stopped, do: [:jido_coder_lib, :session, :stopped]
  ...
  **Metadata:**
  ...
  def session_error, do: [:jido_coder_lib, :session, :error]
  ...
  **Metadata:**
  ...
  def agent_dispatch, do: [:jido_coder_lib, :agent, :dispatch]
  ...
  **Metadata:**
  ...
  def agent_complete, do: [:jido_coder_lib, :agent, :complete]
  ...
  **Metadata:**
  ...
  def agent_error, do: [:jido_coder_lib, :agent, :error]
  ...
  **Metadata:**
  ...
  def llm_request, do: [:jido_coder_lib, :llm, :request]
  ...
  **Metadata:**
  ...
  def llm_response, do: [:jido_coder_lib, :llm, :response]
  ...
  **Metadata:**
  ...
  def llm_error, do: [:jido_coder_lib, :llm, :error]
  ...
  **Metadata:**
  ...
  def context_cache_hit, do: [:jido_coder_lib, :context, :cache_hit]
  ...
  **Metadata:**
  ...
  def context_cache_miss, do: [:jido_coder_lib, :context, :cache_miss]
  ...
  **Metadata:**
  ...
  def context_cache_eviction, do: [:jido_coder_lib, :context, :cache_eviction]
  ...
  **Metadata:**
  ...
  def pubsub_broadcast, do: [:jido_coder_lib, :pubsub, :broadcast]
  ...
  **Metadata:**
  ...
  def pubsub_receive, do: [:jido_coder_lib, :pubsub, :receive]
  ...
  **Metadata:**
  ...
  def registry_register, do: [:jido_coder_lib, :registry, :register]
  ...
  **Metadata:**
  ...
  def registry_unregister, do: [:jido_coder_lib, :registry, :unregister]
