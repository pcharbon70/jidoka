defmodule JidoCoderLib.Memory.LongTerm.SessionServer do
  @moduledoc """
  ...
  * Validates all memory operations using the Validation module
  ...
  Sessions are registered in `JidoCoderLib.Memory.SessionRegistry` for
  ...
  * `{:error, :not_found}` - Memory not found
  ...
  defp via_tuple(session_id) do
    ...
    {:via, Registry, {JidoCoderLib.Memory.SessionRegistry, session_id}}
  end
end
